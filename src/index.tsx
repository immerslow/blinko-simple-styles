  ...
  execute: () => {
    exports('default', class Plugin implements BasePlugin {
      ...
      applyCustomTheme(){
        ...
        style.id = 'my-blinko-custom-theme';

        // 2. Define your CSS here
        // Tip: Use the browser inspector (F12) to find the correct class names for the editor.
        // Common targets might be '.editor-container', 'textarea', or 'body'.
        style.innerHTML = `
            .vditor {
              --second-color: #fff !important;
              --ir-bracket-color: #ff6b6b !important;
              --ir-heading-color: #fff !important;
            }
        ...
        // 3. Attach it to the document head
      ...
      destroy() {
        ...
        const existingStyle = document.getElementById('my-blinko-custom-theme');
        if (existingStyle) {
